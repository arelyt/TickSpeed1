...
namespace TickSpeed
{
    ...
    [HandlerName("SWTDEN4")]
    public class Swtden4Class : IBar2DoubleHandler
    {
        public interface ISwtDen
        {
            double[] func_denoise_sw1d_1_4_auto(double[] in1);
        }
        ...
        public IList<double> Execute(ISecurity security)
        {
            ...
            try
            {
                ISwtDen sigDen = client.CreateProxy<ISwtDen>(new Uri("http://localhost:9910/func_denoise_sw1d_1_4_auto_dep"));
                result = sigDen.func_denoise_sw1d_1_4_auto(values);
            }
