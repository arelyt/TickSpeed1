...
#pragma warning disable 612
    [HandlerName("CasheSignalDouble1")]
#pragma warning restore 612
    public class CasheSignalDouble1Class : ITwoSourcesHandler, ISecurityInput0, IDoubleInput1, IStreamHandler, IDoubleReturns
    {
        
        [HandlerParameter(Name = "Values", Default = "true", NotOptimized = false)]
        public bool Reset { get; set; }
        private static IList<double> Tradecashe1 { get; set; }
        private static IList<double> Doublecashe1 { get; set; }
        ...
        public IList<double> Execute(ISecurity sec, IList<double> bools)
        {
            ...
            if (Doublecashe1.IsNull() || Doublecashe1.IsNull() || Reset)
            {
                
                Tradecashe1 = tradeno.ToList();
                Doublecashe1 = bools.ToList();
                //Tcashe = time.ToList();
            }
            else
            {
            ...
            return Doublecashe1.TakeLast(count).ToArray();          
