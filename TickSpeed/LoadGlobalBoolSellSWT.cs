...
#pragma warning disable 612
    [HandlerName("LoadBoolSellSWT")]
#pragma warning restore 612

    public class LoadGlobalBoolSellSWT : IOneSourceHandler, IContextUses,
                                        IStreamHandler, IBooleanReturns
    {
        ...
        public IList<bool> Execute(ISecurity sec)
        {
            ...
            values[ctx.BarsCount-1] = (bool)ctx.LoadGlobalObject("SiM7TICK64SWT_Sell");
            return values;
        }
