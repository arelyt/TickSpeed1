...
#pragma warning disable 612
    [HandlerName("SSA_V2_2")]
#pragma warning restore 612


    public class IncrementalSSA2 : IOneSourceHandler, IDoubleInputs, IDoubleReturns, IStreamHandler, IContextUses
    {
        ...
        public IList<double> Execute(IList<double> myDoubles)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < count; i++)
                    vals[i] = myDoubles[i];
                alglib.ssacleardata(worker2);
                alglib.ssacleardata(analyzer2);
            ...
            Context.Log("ssaV2_2exec for " + g + " msec", MessageType.Info, toMessageWindow: true);
            return result;
        }
