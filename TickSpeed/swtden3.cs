...
namespace TickSpeed
{
    ...
    [HandlerName("SWTDEN3")]
    public class Swtden3Class : IBar2DoubleHandler
    {
        public interface ISwtDen
        {
            double[] func_denoise_sw1d_1_3_auto(double[] in1);
        }
        ...
        public IList<double> Execute(ISecurity security)
        {
            ...
            try
            {
                ISwtDen sigDen = client.CreateProxy<ISwtDen>(new Uri("http://localhost:9910/func_denoise_sw1d_1_3_auto_dep"));
                result = sigDen.func_denoise_sw1d_1_3_auto(values);
            }
