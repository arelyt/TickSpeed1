...
#pragma warning disable 612
    [HandlerName("CasheSignalDouble3")]
#pragma warning restore 612
    public class CasheSignalDouble3Class : ITwoSourcesHandler, ISecurityInput0, IDoubleInput1, IStreamHandler, IDoubleReturns
    {
        
        [HandlerParameter(Name = "Values", Default = "true", NotOptimized = false)]
        public bool Reset { get; set; }
        private static IList<double> Tradecashe1 { get; set; }
        private static IList<double> Doublecashe3 { get; set; }
        ...
        public IList<double> Execute(ISecurity sec, IList<double> bools)
        {
            ...
            if (Doublecashe3.IsNull() || Doublecashe3.IsNull() || Reset)
            {
                
                Tradecashe1 = tradeno.ToList();
                Doublecashe3 = bools.ToList();
                //Tcashe = time.ToList();
            }
            else
            {
            ...
            return Doublecashe3.TakeLast(count).ToArray();          
