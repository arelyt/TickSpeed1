...
#pragma warning disable 612
    [HandlerName("CasheSignalDownClose")]
#pragma warning restore 612
    public class CasheSignalDownCloseClass : ITwoSourcesHandler, ISecurityInput0, IBooleanInput1, IStreamHandler, IBooleanReturns
    {
        
        [HandlerParameter(Name = "Reset", Default = "true", NotOptimized = false)]
        public bool Reset { get; set; }
        private static IList<double> Tradecashe { get; set; }
        private static IList<bool> Boolcashedownclose { get; set; }
        ...
        public IList<bool> Execute(ISecurity sec, IList<bool> bools)
        {
            ...
            if (Tradecashe.IsNull() || Boolcashedownclose.IsNull() || Reset)
            {
                
                Tradecashe = tradeno.ToList();
                Boolcashedownclose = bools.ToList();
                //Tcashe = time.ToList();
            }
            else
            {
                ...
                Boolcashedownclose.AddRange(bl);
            ...
            return Boolcashedownclose.TakeLast(count).ToArray();          
